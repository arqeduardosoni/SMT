...
export default function App(){
  ...
  function Nav(){
    ...
    {user&&user.id!=="__guest__"&&!isAdmin&&!guest&&(!user.objectivesSet||editObj)&&!trialModal&&!showOnboarding&&!["welcome","auth"].includes(screen)&&<div style={{position:"fixed",inset:0,zIndex:955,background:"#0A0F0C",overflowY:"auto",fontFamily:F.ios}}>
