    ...
    return <div key={screen} style={{minHeight:"100vh",background:IB,color:TX,fontFamily:F.ios,position:"relative"}}>
      ...
      <div style={{position:"relative",zIndex:1,padding:"0 0 90px"}}>
        ...
        <div style={{padding:"0 18px"}}>
          ...
          {(user&&user.id!=="__guest__")&&<div style={{display:"flex",alignItems:"center",gap:7,marginBottom:7}}><Ico n="heart" s={13} c={LIME}/><span style={{fontFamily:F.bc,fontSize:9.5,letterSpacing:"0.18em",color:LIME,fontWeight:700}}>INTEGRACIÓN CON APPLE SALUD</span></div>}
          {(user&&user.id!=="__guest__")&&((health&&health.available!==false)?
