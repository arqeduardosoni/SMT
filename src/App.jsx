    ...
    return <div key={screen} style={{minHeight:"100vh",background:IB,color:TX,fontFamily:F.ios,position:"relative"}}>
      ...
      <div style={{position:"relative",zIndex:1,padding:"0 0 90px"}}>
        ...
        <div style={{padding:"0 18px"}}>
          ...
          <div style={{display:"flex",flexDirection:"column",gap:9}}>
            {R.map(dd=><div key={dd.d} onClick={()=>setDayModal(dd)} className="btn-press" style={{cursor:"pointer",display:"flex",alignItems:"center",gap:11,background:IC,border:dd.today?`1.5px solid ${LIME}`:"1px solid "+IC2,borderRadius:14,padding:"11px 12px"}}>
