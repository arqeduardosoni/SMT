        ...
        <div style={{padding:"0 18px"}}>
          ...
          {(user&&user.id!=="__guest__")&&((health&&health.available!==false)?
            <div style={{background:IC,border:`1px solid ${LIME}55`,borderRadius:16,padding:14,marginBottom:12}}>
              <div style={{display:"flex",alignItems:"center",justifyContent:"space-between",marginBottom:11}}><div style={{display:"flex",alignItems:"center",gap:7}}><Ico n="heart" s={15} c={LIME}/><span style={{fontFamily:F.bc,fontSize:10,letterSpacing:"0.16em",color:LIME,fontWeight:700}}>APPLE WATCH · HOY</span></div><span onClick={connectHealth} className="btn-press" style={{fontFamily:F.ios,fontSize:11,color:C.cyan,cursor:"pointer",fontWeight:600}}>Actualizar</span></div>
            ...
            :
            <div onClick={connectHealth} className="btn-press" style={{cursor:"pointer",background:IC,border:`1px dashed ${LIME}66`,borderRadius:16,padding:"14px",marginBottom:12,display:"flex",alignItems:"center",gap:12}}><div style={{width:42,height:42,borderRadius:12,background:LIME,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}><Ico n="heart" s={22} c={LIMED}/></div><div style={{flex:1,minWidth:0}}><div style={{fontFamily:F.ios,fontSize:14,fontWeight:800,color:TX}}>Conecta tu Apple Watch</div><Sub style={{fontSize:11.5,marginTop:2}}>Lee tus calorías, pasos y ritmo cardiaco reales para ajustar tu plan.</Sub></div><span style={{color:MU,fontSize:20,flexShrink:0}}>›</span></div>
          )}
